...
describe('ValidationHelper', () => {
  ...
  describe('validateSnowflakeId', () => {
    it('should validate correct snowflake ID', () => {
      expect(ValidationHelper.validateSnowflakeId('123456789012345')).toBe(
        true
      );
      expect(ValidationHelper.validateSnowflakeId('1234567890123456789')).toBe(
        true
      );
    });
    ...
    it('should reject invalid snowflake ID', () => {
      ...
      expect(ValidationHelper.validateSnowflakeId('12345678901234567890')).toBe(
        false
      );
