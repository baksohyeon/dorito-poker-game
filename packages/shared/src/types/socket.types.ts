import { PlayerAction, GameState, PlayerState } from "packages/shared/src/types/game.types";
import { PlayerSettings } from "packages/shared/src/types/player.types";
import { Table } from "packages/shared/src/types/table.types";
...
export interface ServerToClientEvents {
    ...
    'game:action-result': (data: { action: PlayerAction; success: boolean; error?: string }) => void;
