...
export const ERROR_MESSAGES: Record<keyof typeof ERROR_CODES, string> = {
    ...
    TABLE_PRIVATE_PASSWORD_REQUIRED: 'This is a private table. Password required.',
    TABLE_PRIVATE_INVALID_PASSWORD: 'Invalid password for private table',
    TABLE_MINIMUM_PLAYERS_NOT_MET: 'Minimum number of players not met to start game',
